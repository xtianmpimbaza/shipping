...
function validate()
 ...
 if (form.Consignment.value == "" )
  ...
  <tbody><tr>
  <td bgcolor="#2284d5" height="40" width="476"><div align="center">
                  <p align="center"> Copyright &copy; 
                      <script type="text/javascript">document.write(new Date().getFullYear());</script> 
                      <strong> <font size="3" color="white">LOMAMI WORD</font> <strong>, Designed and Hosted by  
                              <a href="#"  style="color:white" ><strong> SEA Ltd <strong</a>
              </p>
              </div></td>
