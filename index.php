...
if (isset($_POST['submit'])) {
    $users = checkUser($_POST['username'], $_POST['password']);

    if (!empty($users)) {
        $_SESSION['cid'] = $users['cid'];
        $_SESSION['user_name'] = $users['email'];
...
<!--                <h2>Sign In</h2>-->
            ...
            <div>
                <form method="post" name="loginform" id="loginform" onSubmit="return memloginvalidate()">
    ...
    <div class="nk-block" id="l-forget-password">
        <div class="nk-form">
            <p class="text-left">Enter your email to reset your password</p>
